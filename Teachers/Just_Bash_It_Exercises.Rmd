...
2. Using your `history`, find the commands you used to solve exercise 7.5 and copy them into the file `ex8.sh`. You can use the `echo` command or an editor. Save the script. If you use `echo`, view the script file to verify that it looks as expected. 
