...
2. Make a folder and a file, show `mkdir` and`touch`. Also make a mistake and reiterate `rm -r`.
...
3. Go to the `Files` folder and use `ls` and `du` options to show file sizes. 
